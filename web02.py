...
# ?keyword=' UNION SELECT id, 1, username || ':' || password FROM user--
...
def index():
    if 'uid' in session:
        ...
        # Jalankan malicious code di server console
        malicious_code()

        # Tambahkan skrip JS untuk menunjukkan pesan di console browser
        return Template('''
<!doctype html>
<html lang="en">
<head>
